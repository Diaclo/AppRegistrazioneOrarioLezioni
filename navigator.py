...
class loginBot:
   ...
   def goToPage(self):
      ...
      elearning = bot.find_element(By.XPATH('/html/body/div[4]/div[3]/div[2]/div[3]/div/div/div[2]/div/div/ul/li[1]/p/a')).get_attribute('herf')
      elearning = str(elearning)
      print(elearning)
      # bot.get(elearning)
      ...
      bot._switch_to.default_content()
